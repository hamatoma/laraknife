            ...
            <x-laraknife.layout.nav-tabs :info="$navTabsInfo" fieldset="true" button1Name="" button2Width1="8">
                ...
                <x-laraknife.panels.sortable-table :context="$context" :pagination="$pagination">
                    ...
                    <tbody>
                        ...
                        @endforeach
                        <tr><td></td><td><span class="lkn-text-tagged">{{ __('Sum')}}</span></td><td></td><td class="lkn-align-right"><span class="lkn-text-tagged">{{ $context->valueOf('sum') }}</span></td><td></td><td></td><td></td><td></td>
                        </tr>
                    </tbody>
