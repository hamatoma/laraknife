...
<form id="sproperty-edit" action="/sproperty-update/{{ $context->valueOf('id') }}" method="POST">
    ...
    <x-laraknife.edit-panel title="{{ __('Change of a Scoped Property') }}">
        ...
        <x-laraknife.text position="first" name="name" label="Name" value="{{ $context->valueOf('name') }}"
            width2="4" />
        <x-laraknife.text position="last" name="shortname" label="Shortname" value="{{ $context->valueOf('shortname') }}"
            width2="4" />
        ...
        <x-laraknife.bigtext position="alone" name="info" label="Info" value="{{ $context->valueOf('info') }}"
            width2="10" rows="4" />
